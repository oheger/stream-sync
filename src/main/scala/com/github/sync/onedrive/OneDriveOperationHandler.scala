...
import com.github.sync.http.{HttpOperationHandler, SyncOperationRequestActor}
...
class OneDriveOperationHandler(config: OneDriveConfig) extends HttpOperationHandler[OneDriveConfig] {
  ...
  /**
    ...
    */
  override protected def createNewFileRequest(op: SyncTypes.SyncOperation, file: SyncTypes.FsFile, fileSize: Long, source: Future[Source[ByteString, Any]])(implicit ec: ExecutionContext, mat: ActorMaterializer): Future[SyncOperationRequestActor.SyncOperationRequestData] = ???
  ...
  /**
    ...
    * @return a ''Future'' with request information
    */
  override protected def createUpdateFileRequest(op: SyncTypes.SyncOperation, file: SyncTypes.FsFile, fileSize: Long, source: Future[Source[ByteString, Any]])(implicit ec: ExecutionContext, mat: ActorMaterializer): Future[SyncOperationRequestActor.SyncOperationRequestData] = ???
