...
trait OAuthCommands:
  ...
  /**
    * Lists the current tokens stored for a specific IDP. This can be used for
    * debugging purposes.
    *
    * @param listTokensConfig the configuration of the list tokens command
    * @param storageService   the token storage service
    * @param ec               the execution context
    * @param system           the actor system
    * @return a ''Future'' with the output generated by this operation
    */
  def listTokens(listTokensConfig: ListTokensCommandConfig, storageService: StorageService)
