...
object BaseHttpFsElementSourceSpec {
  ...
  val RootFolder: FsFolder = FsFolder(null, "/", -1)
  ...
  def createSubFolder(parent: FsFolder, idx: Int): FsFolder =
    FsFolder(null, childName(parent, folderName(idx)), parent.level + 1)
  ...
  def createFile(parent: FsFolder, idx: Int): FsFile =
    FsFile(null, childName(parent, fileName(idx)), parent.level + 1,
